...
void GsmHrVad::algorithm(int32_t pL_acf[9],
                            int16_t swScaleAcf,
                            int16_t pswRc[4],
                            int16_t swPtch,
                            int16_t *pswVadFlag)
...
void GsmHrVad::energy_computation(int32_t pL_acf[],
                                 int16_t swScaleAcf,
                                 int16_t pswRvad[],
                                 int16_t swNormRvad,
                                 int16_t *pswM_pvad,
...
void   GsmHrVad::average_acf(int32_t pL_acf[],
                          int16_t swScaleAcf,
                          int32_t pL_av0[],
                          int32_t pL_av1[])
{
...
void   GsmHrVad::predictor_values(int32_t pL_av1[],
                               int16_t pswRav1[],
                               int16_t *pswNormRav1)
{
...
void   GsmHrVad::schur_recursion(int32_t pL_av1[],
                              int16_t pswVpar[])
{
...
void   GsmHrVad::step_up(int16_t swNp,
                      int16_t pswVpar[],
                      int16_t pswAav1[])
{
...
void   GsmHrVad::compute_rav1(int16_t pswAav1[],
                           int16_t pswRav1[],
                           int16_t *pswNormRav1)
{
...
void   GsmHrVad::spectral_comparison(int16_t pswRav1[],
                                  int16_t swNormRav1,
                                  int32_t pL_av0[],
                                  int16_t *pswStat)
{
...
void   GsmHrVad::tone_detection(int16_t pswRc[4],
                             int16_t *pswTone)
{
...
void   GsmHrVad::threshold_adaptation(int16_t swStat,
                                   int16_t swPtch,
                                   int16_t swTone,
                                   int16_t pswRav1[],
                                   int16_t swNormRav1,
...
void  GsmHrVad::vad_decision(int16_t swM_pvad,
                           int16_t swE_pvad,
                           int16_t swM_thvad,
                           int16_t swE_thvad,
                           int16_t *pswVvad)
...
void   vad_hangover(int16_t swVvad,
                           int16_t *pswVadFlag)
{
...
void   GsmHrVad::periodicity_update(int16_t pswLags[4],
                                 int16_t *pswPtch)
{
