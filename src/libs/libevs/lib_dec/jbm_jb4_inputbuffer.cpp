...
{
    JB4_INPUTBUFFER_HANDLE h = (JB4_INPUTBUFFER_HANDLE)malloc( sizeof( struct JB4_INPUTBUFFER ) );
                                     ...
                                     Word16 *replaceWithNewElementIfEqual ) )
{
    ...
    h->data            = (void**)malloc( L_mult0( capacity, sizeof( JB4_INPUTBUFFER_ELEMENT ) ) );
    h->capacity        = capacity;
    move16();
    h->writePos        = 0;
    move16();
