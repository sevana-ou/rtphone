...
{
    JB4_CIRCULARBUFFER_HANDLE h = (JB4_CIRCULARBUFFER_HANDLE)malloc( sizeof( struct JB4_CIRCULARBUFFER ) );
...
Word16 JB4_CIRCULARBUFFER_Init( JB4_CIRCULARBUFFER_HANDLE h, Word16 capacity )
{
    ...
    h->data     = (JB4_CIRCULARBUFFER_ELEMENT*)malloc( capacity * sizeof( JB4_CIRCULARBUFFER_ELEMENT ) );
