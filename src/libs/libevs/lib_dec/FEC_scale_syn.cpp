            ...
            else					/* good frame  */
            {
                ...
                *-----------------------------------------------------------------*/
                ...
                if( ( (last_good >= VOICED_TRANSITION && last_good < INACTIVE_CLAS && (clas == UNVOICED_CLAS || clas == INACTIVE_CLAS)) ||
                        last_core_brate == SID_1k75 || last_core_brate == SID_2k40 || last_core_brate == FRAME__NO_DATA ) && prev_bfi )
                {
            ...
            *-----------------------------------------------------------------*/
            ...
            if( clas == SIN_ONSET )
            {
                ...
                gain1 = 0.5f * gain2;
                     ...
                     last_core_brate == SID_1k75 || last_core_brate == SID_2k40 || last_core_brate == FRAME__NO_DATA )
            {
                /* voiced -> unvoiced signal transition */
                /* CNG -> active signal transition */
                gain1 = gain2;
